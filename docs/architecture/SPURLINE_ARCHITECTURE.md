...
| 17 | Multi-agent orchestration | Child agents inherit at most parent permissions — never more. Flat permission inheritance, no privilege escalation through delegation. |
